...
pub mod chat_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("chat.ChatService", "ChatStream"));
...
pub mod chat_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/chat.ChatService/ChatStream" => {
                    ...
                    struct ChatStreamSvc<T: ChatService>(pub Arc<T>);
                    impl<
                        T: ChatService,
                    ...
                    for ChatStreamSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ChatService>::chat_stream(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "chat.ChatService";
